...
import { getDeviceName, normalizeIoState, calculateTestResults } from "./page-helpers"
import type { IoItem } from "./page-helpers"
import { SyncQueueOverlay } from "./sync-queue-overlay"
  ...
  return (
    ...
    <div className="h-screen bg-background flex flex-col overflow-hidden">
      ...
      */}
      ...
      {/* Sync queue indicator — fixed overlay, no layout shift. Only shows after 3s of continuous pending. */}
      <SyncQueueOverlay
        hasPending={hasDirtyLocalQueues}
        summary={dirtyQueueSummary}
        onOpenSync={handleCloudSync}
      />
