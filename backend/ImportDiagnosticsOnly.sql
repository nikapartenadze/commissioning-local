-- Import ONLY Diagnostic Guides
-- Use this if you're getting I/O data from remote database
-- This just adds the troubleshooting guides to your local database
...
-- Verify import
SELECT 'Diagnostic Guides Imported' as Status, COUNT(*) as Count FROM TagTypeDiagnostics;
